...
var SkipList = require('../alliances/skiplist/skiplist');
...
var SeqQueue = function(opts) {
  ...
  this.curId = INIT_ID;
  //this.queue = [];
  this.queue = new SkipList(function(k1, k2) {
 ...
 * @memberOf SeqQueueManager
 */
SeqQueueManager.createQueue = function(opts) {
	return new SeqQueue(opts);
};
